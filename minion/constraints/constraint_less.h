...
struct LeqConstraint : public Constraint
{
  ...
  { 
	...
	array.push_back(AnyVarRef(x));
	array.push_back(AnyVarRef(y));
	return array;
  }
};
...
{ 
  return 
  (new LeqConstraint<VarRef1,VarRef2,Offset>(v1,v2,o)); 
}
...
{ 
  return 
  (new LeqConstraint<VarRef1,VarRef2,compiletime_val<0> >(v1,v2,compiletime_val<0>())); 
}
...
{ 
  return 
  (new LeqConstraint<VarRef,VarRef,compiletime_val<0> >(v1,v2,compiletime_val<0>())); 
}
