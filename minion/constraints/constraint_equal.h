...
struct ReifiedEqualConstraint : public Constraint
{
  ...
  virtual void propogate(int i, DomainDelta)
  {
    switch(i)
    {
      case 1:
  ...
  { 
    vector<AnyVarRef> vars(3);
	vars[0] = AnyVarRef(var1);
	vars[1] = AnyVarRef(var2);
	vars[2] = AnyVarRef(var3);
    return vars;
  }
};
...
{ 
  return 
  (new ReifiedEqualConstraint<EqualVarRef1, EqualVarRef2, BoolVarRef>(var1,var2,var3)); 
}
...
{ 
  return 
  (new EqualConstraint<EqualVarRef1, EqualVarRef2>(var1,var2)); 
}
