/* Minion Constraint Solver
   ...
   $Id: constraint_fullsum.h 539 2007-02-14 23:14:51Z azumanga $
*/
...
struct LessEqualSumConstraint : public Constraint
{
  ...
  {
    int min_sum = get_real_min_sum();
    int max_diff = get_real_max_diff();
