...
struct BigRangeVarContainer {
  ...
  void addLowerBoundTrigger(BigRangeVarRef_internal b, Trigger t)
  { D_ASSERT(lock_m); trigger_list.add_lower_trigger(b.var_num, t); }
  
  void addUpperBoundTrigger(BigRangeVarRef_internal b, Trigger t)
  { D_ASSERT(lock_m); trigger_list.add_upper_trigger(b.var_num, t);  }
  
  void addAssignedTrigger(BigRangeVarRef_internal b, Trigger t)
  { D_ASSERT(lock_m); trigger_list.add_assign_trigger(b.var_num, t);  }
  
  void addDomainChangedTrigger(BigRangeVarRef_internal b, Trigger t)
  ...
  {  
	...
	D_ASSERT(b.var_num <= var_count_m);
