...
public class SpecialExpressionTranslator extends RelationalExpressionTranslator {
  ...
  protected MinionBoolVariable reifyConstraint(MinionReifiableConstraint constraint) throws 
	  ...
	  if(constraint.getClass().toString().endsWith("translator.minionModel.MinionSumConstraint") ||
			  constraint.getClass().toString().endsWith("translator.minionModel.MinionWeightedSumConstraint")) {
...
/*		else if(negatedExpression.getRestrictionMode() == EssenceGlobals.ALLDIFF || 
				...
				translator.minionModel.addReificationConstraint(constraint, reifiedVariable);
