	...
	*/
    ...
    public int getVectorElementAt(String vectorName, int index) 
    	...
    	if(!this.parameterVectors.containsKey(vectorName)) 
    		throw new PreprocessorException("Trying to access element of unknown vector:"+vectorName);
    	...
    	if(index < 0 || index >= parameterVector.length)
    		throw new PreprocessorException("Index out of bounds of parameter array:"+vectorName+"["+(index+offsets[0])+"].");
    ...
    public int getMatrixElementAt(String matrixName, int rowIndex, int colIndex) 
    	...
    	if(!this.parameterMatrices.containsKey(matrixName)) 
    		throw new PreprocessorException("Trying to access element of unknown matrix:"+matrixName);
    	...
    	if(rowIndex < 0 || rowIndex >= parameterMatrix.length || 
    		...
    		throw new PreprocessorException("Index out of bounds of parameter array:"+matrixName+"["
    ...
    public int getCubeElementAt(String cubeName, int planeIndex, int rowIndex, int colIndex) 
    	...
    	if(!this.parameterCubes.containsKey(cubeName)) 
    		throw new PreprocessorException("Trying to access element of unknown cube:"+cubeName);
    	...
    	if(planeIndex < 0 || planeIndex >= parameterCube.length ||
    		...
    		throw new PreprocessorException("Index out of bounds of parameter array:"+cubeName+"["
