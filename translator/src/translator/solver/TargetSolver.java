...
public interface TargetSolver {
    ...
    //	 GLOBAL CONSTRAINTS
	public final int SUPPORTS_ATMOST = 500;
	public final int SUPPORTS_ATLEAST = 501;
	public final int SUPPORTS_OCCURRENCE = 502;
	public final int SUPPORTS_ELEMENT = 503;
	public final int SUPPORTS_TABLE = 504;
	
	
	public final int SUPPORTS_1DIM_LEX = 600;
	public final int SUPPORTS_2DIM_LEX = 601;
	...
	public final int REIFIED_ATMOST = 259;
