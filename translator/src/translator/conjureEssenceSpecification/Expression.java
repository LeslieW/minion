...
public class Expression implements EssenceGlobals {
   ...
   // ExpressionVector expressionVector; // not in use at the moment
    AtmostConstraint atmostConstraint;
   ...
   // public ExpressionVector getExpressionVector() {
   // 	return this.expressionVector;
    //}
    
    public AtmostConstraint getAtmostConstraint() {
    	return this.atmostConstraint;
    }
	...
	//case EssenceGlobals.EXPRESSION_VECTOR:
	//	return new Expression(this.expressionVector.copy());
		
	case EssenceGlobals.ATMOST:
		return new Expression(this.atmostConstraint.copy());
  ...
  /*  public void setExpression(Expression e){
	...
	//public Expression(ExpressionVector vector) {
	//	this.expressionVector = vector;
	//}
	
	public Expression(AtmostConstraint atmost ) {
		this.atmostConstraint = atmost;
		this.restriction_mode = (atmost.isAtmost) ?
					EssenceGlobals.ATMOST : EssenceGlobals.ATLEAST;
	}
	...
	public String toString() {
		...
		//case EXPRESSION_VECTOR: return this.expressionVector.toString();
		case ATMOST : return this.atmostConstraint.toString();
		case ATLEAST: return this.atmostConstraint.toString();
		}		
		return "";
	}
