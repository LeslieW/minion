...
public class MinionModel implements MinionGlobals {
    ...
    /** list containing MinionConstraints that have been generated outside the translator.minionModel;*/
 ...
 public  MinionModel () {
    ...
    public int add01Variable(MinionBoolVariable variable) {
    	...
    	print_debug("Adding BOOLEAN VARIABLE to translator.minionModel;"+variable.getOriginalName()+", with minionName: x"+variable.getAbsoluteIndex());
    	return index;
    	}
     ...
     * @param variableVector the MinionBoolVariable[] array that should be added to the translator.minionModel;
     * @param offset TODO
     */
    ...
    public void add01VariableVector(MinionBoolVariable[] variableVector, int offset) {		
	  ...
	  for (int i1 = 0; i1 < variableVector.length; i1++) {
		...
		print_debug("Adding BOOLEAN VARIABLE to translator.minionModel;"+variableVector[i1].getOriginalName()+", with minionName: x"+variableVector[i1].getAbsoluteIndex());
	  }
    ...
    public void add01VariableMatrix(MinionBoolVariable[][] matrix, int vectorOffset, int elementOffset) {
		...
		print_debug("Added the MATRIX to the translator.minionModel;:"+matrix[0][0].getOriginalName());
    ...
    public void addEmpty01VariableMatrix(MinionBoolVariable[][] matrix, String originalName, int vectorOffset, int elementOffset) {
		...
		matrices2d.add(newMatrix);
		print_debug("Added the MATRIX to the translator.minionModel;:"+originalName);
   ...
   public void add01VariableCube(MinionBoolVariable[][][] cube, int matrixOffset, int vectorOffset, int elementOffset) {
    	...
    	print_debug("Added the CUBE to the translator.minionModel;:"+cubeName);
   ...
   public void addEmpty01VariableCube(MinionBoolVariable[][][] cube, String originalName, int matrixOffset, int vectorOffset, int elementOffset) {
	   ...
	   matrixOffsets.put(originalName, 
   		...
   		MinionCube newCube = new MinionCube(cube, originalName,
   			                            new int[] { matrixOffset, vectorOffset, elementOffset});
   		matrices3d.add(newCube);
   		print_debug("Added the EMPTY CUBE to the translator.minionModel;:"+originalName);
   ...
   * 		Minion model 	
    ...
    public void addBoundsVariable(MinionBoundsVariable boundsVariable) {  
    	...
    	print_debug("Adding BOUNDSVARIABLE VARIABLE to translator.minionModel;"+boundsVariable.getOriginalName()+", with minionName: x"+boundsVariable.getAbsoluteIndex());
    }
     ...
     * and can only be identified by that).
     * @param variableVector the MinionBoundsVariable[] array that should be added to the translator.minionModel;
     * @param offset TODO
     */
    ...
    public void addBoundsVariableVector(MinionBoundsVariable[] variableVector, int offset) {
    	...
    	for (int i = 0; i < variableVector.length; i++) {
    		...
    		print_debug("Adding BOOLEAN VARIABLE to translator.minionModel;"+variableVector[i].getOriginalName()+", with minionName: x"+variableVector[i].getAbsoluteIndex());
    	}
   ...
   *  */
    ...
    */
    ...
    /**
     * Get the index of the cube with name "originalName" in the translator.minionModel;(index 2 would mean
...
/*	for (i = 0; i < boundsVariables.size(); i++) {
   ...
   */
   ...
   private static void print_debug(String s) {
   	if(DEBUG)
   		System.out.println("[ DEBUG translator.minionModel;] "+s);
   }
  ...
  */
  ...
  public void addIdentifier(MinionIdentifier identifier)
	  ...
	  if ( Class.forName ("translator.minionModel;MinionBoolVariable").isInstance (identifier)) {
	  ...
	  else if ( Class.forName ("translator.minionModel;MinionBoundsVariable").isInstance (identifier)) {
	  ...
	  else if ( Class.forName ("translator.minionModel;MinionSBoundsVariable").isInstance (identifier)) {
			sparseVariables.add((MinionSBoundsVariable) identifier);
			noSparseVariables++;
		}
	  else if ( Class.forName ("translator.minionModel;MinionDiscreteVariable").isInstance (identifier)) {
	  ...
	  else if( Class.forName ("translator.minionModel;MinionDiscreteSVariable").isInstance (identifier)) {
			discreteSparseVariables.add((MinionDiscreteSVariable) identifier);
			noDiscreteSparseVariables++;
		}
	  
	  else if( Class.forName ("translator.minionModel;MinionConstant").isInstance (identifier)) {
			return;
		}
	  else 
		  throw new MinionException
	  	...
	  	print_debug("Adding VARIABLE to translator.minionModel;"+identifier.getOriginalName()+", with minionName: x"+identifier.getAbsoluteIndex());
  }
  
  /**
   * Add a variable vector that consists only of known elements, that already have been
   * added to the translator.minionModel;
   * 
   * @param variableVector
 * @param offset
 * @param originalName TODO
  ...
  public void addIdentifierVector(MinionIdentifier[] variableVector, int offset)
	throws ClassNotFoundException, MinionException {
	  ...
	  for(int i=0; i<variableVector.length; i++)
		  print_debug("Adding VARIABLE to translator.minionModel;"+variableVector[i].getOriginalName()+
	  ...
	  if ( Class.forName ("translator.minionModel;MinionBoolVariable").isInstance (variableVector[0])) {
	  ...
	  else if ( Class.forName ("translator.minionModel;MinionBoundsVariable").isInstance (variableVector[0])) {
	  ...
	  else if ( Class.forName ("translator.minionModel;MinionDiscreteVariable").isInstance (variableVector[0])) {
  ...
  public void addIdentifierMatrix(MinionIdentifier[][] variableMatrix, int[] offset)
	throws ClassNotFoundException, MinionException {
	  ...
	  if ( Class.forName ("translator.minionModel;MinionBoolVariable").isInstance (variableMatrix[0][0])) 
		add01VariableMatrix((MinionBoolVariable[][]) variableMatrix, offset[0], offset[1]);
	  	
	  
	  else if ( Class.forName ("translator.minionModel;MinionBoundsVariable").isInstance (variableMatrix[0][0])) 
		addBoundsVariableMatrix(( MinionBoundsVariable[][]) variableMatrix, offset[0], offset[1]);
	  
	  else if ( Class.forName ("translator.minionModel;MinionDiscreteVariable").isInstance (variableMatrix[0][0])) 
