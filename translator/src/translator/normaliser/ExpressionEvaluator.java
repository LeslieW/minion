...
public class ExpressionEvaluator  {
    ...
    */
    public ExpressionEvaluator(HashMap<String, Constant> params, 
     ...
     *  @exception NormaliserException is thrown when 
    ...
    */
    ...
    private Expression insertParameterArrayElement (NonAtomicExpression matrixElement) 
	  ...
	  case 2: // matrix
		  ...
		  if(!(matrixValue == NormaliserSpecification.UNDEFINED_PARAMETER_ARRAY_ELEMENT))
 ...
 public Domain evalExpressionInDomain(Domain d) 
	...
	case EssenceGlobals.IDENTIFIER_RANGE: // IdentifierDomain :  identifier  [ { rangeAtom' } ]
    	...
    	if(constant == null) 
    		...
    		throw new NormaliserException("Constant identifier used as domain identifier: "+d.getIdentifierDomain().getIdentifier());	
 ...
 */
     ...
     * @throws NormaliserException
     */
    public IntegerDomain orderIntegerDomain(IntegerDomain intDomain) throws NormaliserException {
   ...
   *  */
    ...
    private void print_debug(String s) {
    	this.debug = debug.concat("[ DEBUG expressionEvaluator ] "+s+"\n");
    }
    ...
    private void print_message(String s) {
    	this.message = message.concat("[ MESSAGE expressionEvaluator ] "+s+"\n");
    }    
