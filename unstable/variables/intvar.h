...
struct RangeVarContainer {
  ...
  void addLowerBoundTrigger(RangeVarRef_internal b, Trigger t)
  { D_ASSERT(lock_m); trigger_list.add_lower_trigger(b.var_num, t); }
  
  void addUpperBoundTrigger(RangeVarRef_internal b, Trigger t)
  { D_ASSERT(lock_m); trigger_list.add_upper_trigger(b.var_num, t);  }
  
  void addAssignedTrigger(RangeVarRef_internal b, Trigger t)
  { D_ASSERT(lock_m); trigger_list.add_assign_trigger(b.var_num, t);  }
  
  void addDomainChangedTrigger(RangeVarRef_internal b, Trigger t)
